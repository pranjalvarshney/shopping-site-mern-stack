    ...
    <div className='container section-1'>
      <div className='content-wrapper'>
        ...
        {/* <div className='badge-flex mt-5'>
          ...
          <span className='badge badge-danger m-1 px-3 py-2'>
            Love And Romance
          </span>
          <span className='badge badge-danger m-1 px-3 py-2'>Propose</span>
          <span className='badge badge-warning m-1 px-3 py-2'>Sorry</span>
          <span className='badge badge-danger m-1 px-3 py-2'>
            Get Well Soon
          </span>
          <span className='badge badge-warning m-1 px-3 py-2'>
            Congratulations
          </span>
