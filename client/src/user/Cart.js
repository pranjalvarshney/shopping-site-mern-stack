...
export const Cart = () => {
  ...
  return (
    <Base className="container pt-5 ">
      {loading ? (
        <div className="py-3" style={{zIndex:"1", display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column"}}>
          <img src="loading.gif" alt="loading" />
          
          <h3 style={{zIndex:10,marginTop:"-100px"}}>Processing your order!</h3>
        </div>
      ) : !success ? (
        ...
        <PaymentSuccess successInfo={successInfo} />
      )}
    </Base>
  )
}
